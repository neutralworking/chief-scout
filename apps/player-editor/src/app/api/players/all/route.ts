...
const SELECT =
  "person_id, name, dob, height_cm, preferred_foot, active, nation, club, position, level, overall, archetype, model_id, profile_tier, personality_type, pursuit_status, market_value_tier, true_mvt, market_value_eur";
