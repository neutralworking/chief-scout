...
import type { Card, SlottedCard } from '../../lib/kickoff-clash/scoring';
import type { RunState, MatchResult, DurabilityResult } from '../../lib/kickoff-clash/run';
import {
  createRun,
  getOpponent,
  getOpponentBuild,
...
import { rehydrateJokers } from '../../lib/kickoff-clash/jokers';
import type { PackType } from '../../lib/kickoff-clash/packs';
import { openPack } from '../../lib/kickoff-clash/packs';
import { getTacticById, rehydrateTacticSlots } from '../../lib/kickoff-clash/tactics';
import { calculateAttendance, getTransferFee } from '../../lib/kickoff-clash/economy';
