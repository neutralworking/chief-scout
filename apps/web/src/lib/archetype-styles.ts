...
const ARCHETYPE_STYLES: Record<string, ArchetypeStyle> = {
  ...
  Magician:  { category: "elite_attacking", color: "#f59e0b", bgClass: "bg-amber-500/15",  textClass: "text-amber-400" },
  ...
  Heartbeat: { category: "creative", color: "#818cf8", bgClass: "bg-indigo-500/15",  textClass: "text-indigo-400" },

  // ── Physical / Combative ─────────────────────────────────
  Titan:     { category: "physical", color: "#d97706", bgClass: "bg-amber-600/15",   textClass: "text-amber-500" },
  ...
  Assassin:  { category: "direct", color: "#f97316", bgClass: "bg-orange-500/15", textClass: "text-orange-400" },

  // ── Defensive ────────────────────────────────────────────
  Fortress:  { category: "defensive", color: "#94a3b8", bgClass: "bg-slate-400/15",  textClass: "text-slate-300" },
  Conductor: { category: "defensive", color: "#64748b", bgClass: "bg-slate-500/15",  textClass: "text-slate-400" },
