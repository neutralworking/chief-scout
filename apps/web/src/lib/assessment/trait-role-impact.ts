...
export const TRAIT_ROLE_IMPACT: Record<string, Record<string, number>> = {
  press_resistant: {
    ...
    "Inverted Full-Back": 7, "Mezzala": 5, "False 9": 7, "Trequartista": 6,
    "Sweeper Keeper": 6, "Ball-Carrying CB": 8,
  },
  flamboyant: {
    "Trequartista": 8, "Inside Forward": 5, "Inverted Winger": 5, "False 9": 4,
  ...
  elegant: {
    "Trequartista": 7, "Regista": 6, "False 9": 5, "Advanced Playmaker": 5,
    "Wide Playmaker": 5, "Inverted Winger": 5, "Ball-Playing CB": 4,
    "Stopper": -3, "Ball-Winner": -2,
  },
  aerial_threat: {
    "Target Man": 10, "Stopper": 7, "Complete Forward": 5, "Ball-Playing CB": 3,
    "Sweeper": 3,
    "False 9": -2, "Regista": -1,
  },
  endurance: {
  ...
  set_piece_specialist: {
    ...
    "Target Man": 5, "Complete Forward": 3,
  },
  ...
  big_game_player: {
    "Complete Forward": 7, "Target Man": 6, "Poacher": 6,
