...
BLUEPRINT_MAP = {
    ...
    ("DM", "Destroyer"): "Sentinelle",
    ("DM", "Destroyer-Cover"): "Sentinelle",
    ("DM", "Destroyer-Engine"): "Box-to-Box Anchor",
    ("DM", "Destroyer-Commander"): "Sentinelle",
    ("DM", "Destroyer-Target"): "Sentinelle",
    ("DM", "Destroyer-Powerhouse"): "Sentinelle",
...
PERSONALITY_UPGRADES = {
    ...
    # ── Defensive midfield ──
    ("Sentinelle", "Captain"):       "Warrior",
    ("Sentinelle", "General"):       "Shield",
