...
PHILOSOPHY_ROLES = {
    "garra_charrua": [
        ("Stopper", "essential", "The warrior CB — wins duels, sets the tone"),
        ("Ball-Winner", "essential", "Aggressive midfield enforcer"),
        ("Anchor", "preferred", "Shields the defence with discipline"),
        ("Target Man", "preferred", "Holds ball up, aerial threat from set pieces"),
        ("Box-to-Box", "preferred", "Covers every blade of grass"),
        ("Shot Stopper", "compatible", "Traditional keeper, commands area"),
    ],
    "catenaccio": [
        ("Sweeper", "essential", "The libero — last man, reads danger"),
        ("Stopper", "essential", "Marks the striker, wins every duel"),
        ("Anchor", "essential", "Positional discipline in front of defence"),
        ("Poacher", "preferred", "Clinical from few chances"),
        ("Inverted Full-Back", "preferred", "Tucks in defensively, adds numbers"),
        ("Deep Playmaker", "compatible", "Controls tempo from deep"),
    ],
    "joga_bonito": [
        ("Trequartista", "essential", "The free-roaming 10 — pure creativity"),
        ("Inside Forward", "essential", "Cuts inside, creates and scores"),
        ("Wide Playmaker", "preferred", "Drifts and creates from the flanks"),
        ("False 9", "preferred", "Drops deep, links play"),
        ("Mezzala", "preferred", "Arrives in the box from deep"),
        ("Complete Forward", "compatible", "All-round threat"),
    ],
    "total_football": [
        ("Box-to-Box", "essential", "Covers multiple positions seamlessly"),
        ("Ball-Playing CB", "essential", "Defender who joins the attack"),
        ("Mezzala", "essential", "Half-space runner, positional interchange"),
        ("Wing-Back", "preferred", "Full-pitch coverage"),
        ("False 9", "preferred", "Positional fluidity in attack"),
        ("Regista", "preferred", "Deep orchestrator"),
    ],
    "la_masia": [
        ("Regista", "essential", "The Busquets role — dictates tempo from the pivot"),
        ("Deep Playmaker", "essential", "The Xavi role — receives deep, orchestrates"),
        ("Mezzala", "essential", "The Iniesta role — arrives in the box from the half-space"),
        ("Ball-Playing CB", "essential", "Builds from the back"),
        ("False 9", "preferred", "The Messi role — drops deep, creates space"),
        ("Inverted Full-Back", "preferred", "Tucks inside to form midfield diamond"),
        ("Sweeper Keeper", "preferred", "High line, distribution"),
    ],
    "gegenpressing": [
        ("Pressing Forward", "essential", "Leads the counter-press from the front"),
        ("Ball-Winner", "essential", "Wins the ball in the middle third"),
        ("Box-to-Box", "essential", "Covers both ends with intensity"),
        ("Wing-Back", "preferred", "Full-pitch energy"),
        ("Inside Forward", "preferred", "Presses and transitions"),
        ("Sweeper Keeper", "preferred", "High line support, distribution"),
    ],
    "bielsismo": [
        ("Wing-Back", "essential", "Extreme width, tireless running"),
        ("Pressing Forward", "essential", "Man-marks the CB, relentless"),
        ("Ball-Winner", "essential", "Man-oriented pressing in midfield"),
        ("Direct Winger", "preferred", "Beats fullback 1v1, creates width"),
        ("Mezzala", "preferred", "Arrives in the box from the half-space"),
        ("Ball-Playing CB", "compatible", "Starts attacks from the back"),
    ],
    "cholismo": [
        ("Anchor", "essential", "Shields the back four, positional anchor"),
        ("Stopper", "essential", "Aggressive, front-foot CB"),
        ("Poacher", "essential", "Clinical from counter-attacks"),
        ("Wide Forward", "preferred", "Pace on the transition"),
        ("Box-to-Box", "preferred", "Covers the midfield"),
        ("Overlapping Full-Back", "compatible", "Provides width when needed"),
    ],
    "pomo": [
        ("Target Man", "essential", "Aerial dominance, hold-up play"),
        ("Stopper", "essential", "Physical, aggressive defending"),
        ("Overlapping Full-Back", "preferred", "Delivers set-piece crosses"),
        ("Anchor", "preferred", "Sits and protects"),
        ("Traditional Winger", "preferred", "Delivers crosses into the box"),
        ("Poacher", "compatible", "Feeds off second balls and set pieces"),
    ],
    "fergie_time": [
        ("Box-to-Box", "essential", "The Keane/Scholes engine room"),
        ("Inside Forward", "essential", "The Ronaldo/Giggs wing threat"),
        ("Complete Forward", "essential", "The all-round 9"),
        ("Direct Winger", "preferred", "Pace and directness on the flanks"),
        ("Ball-Playing CB", "preferred", "Builds from the back when needed"),
