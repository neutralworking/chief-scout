...
42 roles total, differentiated by position + model compound.
...
ROLES = [
    ...
    ("Ball Winner",        "CM", "Engine",      "Destroyer"),
    ("Carrilero",          "CM", "Engine",      "Cover"),
    ...
    ("Incursore",          "AM", "Engine",      "Striker"),
    ("Mediapunta",         "AM", "Controller",  "Creator"),
