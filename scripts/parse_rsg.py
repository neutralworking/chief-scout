"""
parse_rsg.py — Parse rsg.db Obsidian vault + Real Players Active.csv
and upsert to Supabase.

Usage:
    SUPABASE_URL=... SUPABASE_KEY=... python scripts/parse_rsg.py [--dry-run]
...
RSG_MEN = Path(__file__).parent.parent / "docs/research/rsg.db/main/men"
RSG_WOMEN = Path(__file__).parent.parent / "docs/research/rsg.db/main/women"
CSV_REAL = Path(__file__).parent.parent / "docs/Imports/Real Players Active.csv"
CLUBS_CSV = Path(__file__).parent.parent / "docs/Imports/clubs.csv"
